...
func benchmarkGet(b *testing.B, tree *rbTree, size int) {
	for i := 0; i < b.N; i++ {
		for n := 0; n < size; n++ {
			tree.Get(n)
		}
...
func benchmarkPut(b *testing.B, tree *rbTree, size int) {
	for i := 0; i < b.N; i++ {
		for n := 0; n < size; n++ {
			tree.Put(n, struct{}{})
		}
...
func benchmarkRemove(b *testing.B, tree *rbTree, size int) {
	for i := 0; i < b.N; i++ {
		for n := 0; n < size; n++ {
			tree.Remove(n)
		}
